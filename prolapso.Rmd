...
Todas as pacientes com diagnóstico de **prolapso genital** são convidadas a participar do projeto de pesquisa **"Fatores de Risco, Diagnóstico, Tratamento e Prognóstico do Prolapso Genital e Incontinência Urinária Feminina"**. Caso aceitem, são solicitas a preencher o consentimento informado e os formulários da pesquisa.
...
-   Questionários de autopreenchimento (são entregues às pacientes pela recepcionista e preenchidos antes da consulta):
...
![](Figuras/Imagem1.png "Estímulo a doar sangue"){width="181" height="86"}
...
![Pontos e medidas do POP-Q; Fonte: Bump, 1996](Figuras/Figura_1.png)
