...
### **Bases anatômicas para o mecanismo de armazenamento e micção**

O modelo da figura resume as bases anatômicas para o mecanismo de abertura ou fechamento da uretra.

O sistema apresenta o fechamento normal da uretra.

O controle cortical recebe impulsos nervosos desencadeados pelos receptores de estiramento "N", situados no trígono vesical, através fibras nervosas aferentes. Quando necessário, o córtex ativa o mecanismo de micção. Perifericamente, o controle é feito pelo mecanismo músculo-elástico que responde aos estímulos corticais através das fibras eferentes. Veja a referência para melhor compreensão. [@petros2022anatomical]



<div style="margin-bottom: 30px;">

![**Modelo do controle central e periférico da micção/armazenamento**; FONTE: adaptado de Petros, 2022.](images/mecanismo_continencia.jpg){width="750"}
...
Vários sintomas estão associados às lesões anatômicas. A figura abaixo resume os sintomas de acordo com o compartimento ou ligamento afetado.





![**Algoritmo diagnóstico:** ligamento pubo-uretral (PUL); arco tendineo da fáscia pélvica (ATFP); ligamento cardinal (CL); ligamento uterossacro (USL); corpo perineal (PB); FONTE: adaptado de Petros, 2022.](Figuras/algoritmo_sintomas.png){width="750"}
