...
subtitle: "Clínica de Ginecologia do Hospital Universitário Pedro Ernesto - UERJ"

author: "Dr. Ricardo José de Souza - Coordenador do ambulatório"
...
As pacientes devem ser inseridas no banco de dados criado para o ambulatório (Projeto prolapso), através do endereço do REDCap via web: [ww.redcap.lampada.uerj.br](http://www.redcap.lampada.uerj.br). Todos os itens abaixo devem ser preenchidos na primeira consulta:
...
Pacientes submetidas a cirurgia (preencher no [REDCap](www.redcap.lampada.uerj.br)):
...
-   Primeira revisão entre 20 e 30 dias (casos excepcionais devem ser avaliados
    individualmente);
...
-   Revisão da cirurgia (preencher no REDCap e MV): devem ser preenchidas em 6, 12 e 24
    meses após a cirurgia todas as informações abaixo:
...
![Fig 1. Pontos e medidas do POP-Q](Figura_1.png){width="450"}
...
Esse sistema utiliza o anel himenal como ponto fixo de referência, sendo este o **ponto *zero****.* Toda estrutura que se encontra acima (direção cranial - proximal), recebe um valor
negativo e toda estrutura abaixo (caudal - distal) recebe valores positivos.

São utilizados seis pontos de referência para realizar as medidas:

**Aa**: ponto situado na linha média da parede anterior da vagina, a 3 cm do óstio uretral. Coincide com a junção uretrovesical (colo vesical). Esse ponto pode variar de **-3 a +3**, por
definição.
...
#### **CLASSIFICAÇÃO DOS ESTÁGIOS DO PROLAPSO (POP-Q)**
...
+-----------+---------------------------------------------------------------------+
| I         | Quando a medida está 1 cm ou mais acima do anel                     |
|           | himenal                                                             |
+-----------+---------------------------------------------------------------------+
| II        | Quando a medida está entre 1 cm acima e 1 cm abaixo do              |
|           | anel himenal                                                        |
+-----------+---------------------------------------------------------------------+
| II        | Quando a medida está 1 cm abaixo do anel himenal,                   |
|           | porém menor do que 2 cm do comprimento total da vagina (CTV -- 2cm) |
+-----------+---------------------------------------------------------------------+
| IV        | Quando a medida está entre 2 cm do comprimento total                |
|           | da vagina e a sua eversão completa (CTV ± 2cm)                      |
+-----------+---------------------------------------------------------------------+

#### **EXEMPLOS**

![Fig 2. Estadiamento do prolapso genital](Figura_2.png){width="391"}

![Fig 3. Estadiamento do prolapso genital](figura_3.png){width="389"}

<!-- INSERIR AS FIGURAS FALTANTES -->
...
-   Avaliação com questionário de qualidade de vida específico ("*International
    Consultation on Incontinence Questionnaire - Short Form*" ICIQ-SF)

-   Diário miccional e verificação de resíduo pós-miccional poderão ser aplicados em casos
    específicos.

-   Estudo Urodinâmico

    1.  Prolapsos genitais associados a perda
        urinária (sinal ou sintoma);
...
6.  Mirabegrona (Myrtric®): 25 a 50 mg 1x/dia.
