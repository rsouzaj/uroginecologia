...
author: Dr. Ricardo José de Souza ^[Coordenador do ambulatório de uroginecologia no
  HUPE e urologia feminina do Núcleo de Disfunção Miccional na Policlínica Piquet
  Carneiro]
date: "versão 2021.1"
output:
  html_document:
  ...
  pdf_document:
    toc: yes
    toc_depth: '5'
subtitle: Serviço de Ginecologia ^[Hospital Universitário Pedro Ernesto - UERJ]
link-citations: yes
...
![Medidas com as estruturas pélvicas na posição normal](Posicao_normal.png "Posição normal dos órgãos genitais")

![Medidas no prolapso genital completo](Prolapso%20completo.png "Prolapso genital completo"){width="760"}
...
![Algorítimo de conduta na incontinência urinária](Algor%C3%ADtimo_iu_ambulat%C3%B3rio.png){width="890" height="527"}
