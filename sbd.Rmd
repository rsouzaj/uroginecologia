...
A síndrome da bexiga dolorosa (SBD) ou cistite intersticial, como era cohecida antes, é uma doença crônica cujos sintomas duram mais de 6 semanas, com exame de urina normal e cultura negativa.

**Devemos caracterizar:**

1.  Número de micções diárias

2.  Sensação de urgência miccional, geralmente associada a dor ou desconforto durante o enchimento vesical
...
Em caso de dúvidas, podemos realizar um estudo urodinâmico ou cistoscopia; esses exames não são necessários para o diagnóstico em apresentações não complicadas. Não há uma clara concordância nos achados de cistoscopia ou de urodinâmica para o diagnóstico. O único achado consistente com o diagnóstico de SBD são as úlceras de Hunner, presentes em menos de 20% dos casos. Porém, as úlceras são mais frequentes em pacientes acima de 50 anos, o que pode justificar a cistoscopia em mulheres acima dessa idade.
...
![Algorítmo de avaliação de mulheres com suspeita de SBD; Fonte: adaptado de Clemens, 2022](Figuras/SBD_1.png)

<div>

![Fonte, adaptado de Clemens, 2022](Figuras/SBD_2.png)
